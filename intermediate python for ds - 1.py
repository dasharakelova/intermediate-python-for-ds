...
plt.hist(year, bins=5) #на сколько плашек разделятся данные

#другое полезное
plt.clf()#заново выбрать, какой график строить. нужно, когда в одной программе несколько графиков, иначе они наложатся друг на друга
help(plt.hist)#документация
plt.xscale('log')#если некоторые наблюдения слишком сильно отличаются от остальных, поэтому остальные плохо видны
